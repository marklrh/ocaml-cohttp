...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6790b35d86c3f0782e4f322873b65ed0) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the effect library";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Cohttp_effect_io"; "Cohttp_effect"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "effect";
                      lib_findlib_containers = []
                   });
               Library
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "A\128'\016\174\1990\213\017\204|y\021\196\205z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
